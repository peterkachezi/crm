    ...
    swal(
        ...
        function () {
            ...
            $.ajax({
                ...
                url: "/Claims/NpsPrincipals/ApproveMember?Id=" + id + "&Relation=" + relation,
...
$("#btnSuspend").click(function () {
    ...
    swal(
        ...
        function () {
            ...
            $.ajax({
                type: "POST",
                url: "/Claims/NpsPrincipals/SuspendMember", // NB: Use the correct action name
                data: formData,
                dataType: 'json',
                contentType: false,
                processData: false,
...
function GetDependantDocuments(e, name) {
    ...
    $.ajax({
        ...
        url: '/Claims/NpsPrincipals/GetMemberDocuments?MemberNumber=' + memberNumber,
    ...
    swal(
        ...
        function () {
            ...
            $.ajax({
                ...
                url: "/Claims/NpsPrincipals/ReinstateMember/" + id,
