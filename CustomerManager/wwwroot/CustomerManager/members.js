    ...
    swal(
        ...
        function () {
            ...
            $.ajax({
                ...
                url: "/Claims/Members/ApproveMember?Id=" + id + "&Relation=" + relation,
    ...
    swal(
        ...
        function () {
            ...
            $.ajax({
                ...
                url: "/Claims/OtherSchemes/ApproveMember?AutoId=" + autoId,
...
$("#btnSuspend").click(function () {
    ...
    swal(
        ...
        function () {
            ...
            $.ajax({
                type: "POST",
                url: "/Claims/Members/SuspendMember", // NB: Use the correct action name
                data: formData,
                dataType: 'json',
                contentType: false,
                processData: false,
...
function GetDependantDocuments(e, name) {
    ...
    $.ajax({
        ...
        success: (result) => {
            ...
            $("#txtMemberNumber").val(memberNumber);
...
function GetEditDetails(m) {
    ...
    $.get("/Claims/OtherSchemes/GetByMemberNumber/?MemberNumber=" + memberNumber, function (data, status) {
        ...
        if (data.data == null) {
            ...
            $("#txtEditDateOfBirth").val(data.data.newDOB);
...
$("#btnUpdateDetails").click(function () {
    ...
    swal(
        ...
        function () {
            ...
            $.ajax({
                type: "POST",
                url: "/Claims/OtherSchemes/UpdateDetails", // NB: Use the correct action name
                data: formData,
                dataType: 'json',
                contentType: false,
                processData: false,
...
function GetMemberRecord(e) {
    ...
    $.get("/Claims/OtherSchemes/GetByAutoId/?AutoId=" + autoId, function (data, status) {
...
$("#btnRegisterMember").click(function () {
    ...
    var formData = new FormData($('#frmRegisterMember').get(0));

    $.ajax({
        type: "POST",
        url: "/Claims/Registration/Create", // NB: Use the correct action name
        data: formData,
        dataType: 'json',
        contentType: false,
        processData: false,
        ...
        success: function (response) {
            ...
            if (response.success) {
                ...
                var memberNo = response.responseText.memberNumber;

                var scheme_Id = response.responseText.schemeId;

                $("#txtMemberNo").val(memberNo);

                $("#txtSchemeId").val(scheme_Id);
...
$("#btnRegisterDependantMember").click(function () {
    ...
    $("#ModalCreateDependant").modal('hide');



    $("#divLoader").show();

    var formData = new FormData($('#frmRegisterDependantMember').get(0));

    $.ajax({
        type: "POST",
        url: "/Claims/Registration/CreateDependant", // NB: Use the correct action name
        data: formData,
        dataType: 'json',
        contentType: false,
        processData: false,
...
$("#btnAddDependant").click(function () {
    ...
    var url = "/Claims/Registration/Details?MemberNumber=" + memberNo + "&SchemeId=" + schemeId;
